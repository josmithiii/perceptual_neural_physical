...
Mi25 M-icassp25: $(SAVE_DIR)/taslp25/x/taslp25_train_audio.h5
...
ri25pl run-icassp25-ploss: $(SAVE_DIR)/taslp25/x/taslp25_train_audio.h5
...
rt25sl run-taslp25-specloss: $(SAVE_DIR)/taslp25/x/taslp25_train_audio.h5
	@echo "Training EfficientNet with PNP-loss (TASLP25)..."
	cd taslp25/ && source ../.venv/bin/activate && python 04_train_effnet_specloss.py $(SAVE_DIR)/taslp25 $(INIT_ID) 1 1 adam ftm
